...
export default function SwapComponent() {
  ...
  // Removed the outer div that was causing vertical centering and full-screen height
  return (
      ...
      <div className="space-y-4">
          ...
          <div className="flex items-center bg-gray-100 rounded-lg p-3">
            <div className="flex items-center flex-1">
              <div className="relative">
                <button onClick={() => setPayDropdownOpen(!payDropdownOpen)} className="flex items-center bg-white border border-gray-300 rounded-full py-1 px-2 mr-2">
              ...
              <input type="number" className="bg-transparent text-gray-800 text-right flex-1 focus:outline-none" placeholder="0" defaultValue="50.00" />
            </div>
            <button className="ml-2 px-3 py-1 bg-gray-200 text-gray-800 text-sm rounded-full hover:bg-gray-300">Max</button>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="flex items-center bg-gray-100 rounded-lg p-3">
            <div className="flex items-center flex-1">
              <div className="relative">
                <button onClick={() => setReceiveDropdownOpen(!receiveDropdownOpen)} className="flex items-center bg-white border border-gray-300 rounded-full py-1 px-2 mr-2">
              ...
              <input type="number" className="bg-transparent text-gray-800 text-right flex-1 focus:outline-none" placeholder="0" defaultValue="25.00" readOnly />
            </div>
          </div>
        </div>
        ...
        {/* Swap Button */}
        <button className="w-full py-3 bg-[#e2be08] text-gray-900 rounded-lg font-semibold hover:bg-[#c7a707] transition-colors mb-4">Swap</button>
        ...
        <div className="mb-4">
          ...
          >
            Advanced Options
            {advancedOptionsOpen ? <ChevronUp className="ml-2" size={20} /> : <ChevronDown className="ml-2" size={20} />}
          </button>
        </div>
        ...
        {advancedOptionsOpen && (
          <div className="space-y-4 mb-4 p-4 bg-gray-100 rounded-lg">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Custom Fee</label>
              <input
                type="text"
                value={customFee}
        ...
        <div className="space-y-2 text-sm bg-gray-100 p-4 rounded-lg">
          ...
          <div className="flex justify-between">
            ...
            <span className="text-gray-800">
              0.5% <Info className="inline text-gray-600" size={14} />
            </span>
          </div>
          <div className="flex justify-between">
            <span className="text-gray-700">Minimum received:</span>
            <span className="text-gray-800">
              24.88 {receiveToken.symbol} <Info className="inline text-gray-600" size={14} />
            </span>
          </div>
          <div className="flex justify-between">
            <span className="text-gray-700">Price Impact:</span>
            <span className="text-gray-800">
              {"< 0.01%"} <Info className="inline text-gray-600" size={14} />
            </span>
          </div>
          <div className="flex justify-between">
            <span className="text-gray-700">Network Fee:</span>
            <span className="text-gray-800">
              0.00001 XLM <Info className="inline text-gray-600" size={14} />
            </span>
          </div>
          <div className="flex justify-between">
            <span className="text-gray-700">Exchange Fee:</span>
            <span className="text-gray-800">
              Free <Info className="inline text-gray-600" size={14} />
            </span>
          </div>
        </div>
      </div>
